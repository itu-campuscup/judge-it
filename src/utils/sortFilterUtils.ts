...
/**
 * Performance Optimization: Uses Schwartzian Transform to reduce expensive timeToMilli calls.
 ...
 * Uses Schwartzian Transform to optimize heat ID comparison and time parsing.
 * Note: Returns a new array to avoid in-place mutation.
 * @param {Array} timeLogs - The list of time logs.
